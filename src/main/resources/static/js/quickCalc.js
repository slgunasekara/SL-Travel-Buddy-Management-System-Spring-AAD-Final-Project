/* =========================================================================
   quickCalc.js — a standalone floating "quick access" calculator, opened
   from the icon button in the topbar (next to the clock). Purely additive
   UI — does not touch any existing page logic or the calculator already
   present on the Tools page.
   ========================================================================= */
