...
const NAV_ITEMS = [
  ...
  { hash: "#/bus-calendar", icon: "calendar", label: "Booking Calendar" },
  ...
  { hash: "#/attendance", icon: "calendar", label: "Attendance & Leave" },
  { hash: "#/salaries", icon: "wallet", label: "Employee Salary" },
  { hash: "#/maintenance", icon: "wrench", label: "Maintenance" },
  { hash: "#/accidents", icon: "alert", label: "Accidents" },
  { hash: "#/license-insurance", icon: "fileShield", label: "License & Insurance" },
  { hash: "#/financial", icon: "wallet", label: "Financial" },
  ...
  { hash: "#/todo", icon: "listCheck", label: "To-Do List" },
...
const ICONS = {
  ...
  alert: '<path d="M12 3l10 18H2z"/><path d="M12 10v4"/><circle cx="12" cy="17" r="1"/>',
  ...
  listCheck: '<path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 6l1.5 1.5L8 5"/><path d="M4 12l1.5 1.5L8 11"/><path d="M4 18l1.5 1.5L8 17"/>',
  shield: '<path d="M12 3l7 3v6c0 4.5-3 7.7-7 9-4-1.3-7-4.5-7-9V6z"/>',
  fileShield: '<path d="M12 2l6 2.5v5c0 4-2.6 6.8-6 7.8-3.4-1-6-3.8-6-7.8v-5z"/><path d="M9.5 9.3l1.8 1.8 3.2-3.6"/>',
...
const Router = (() => {
  ...
  function render() {
    ...
    qs("#pageTitle").textContent = item ? item.label : (hash === "#/bus-timeline" ? "Bus Timeline" : "Dashboard");
