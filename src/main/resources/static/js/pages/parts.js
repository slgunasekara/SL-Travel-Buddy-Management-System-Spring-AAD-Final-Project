...
function renderPartsPage(container) {
  ...
  renderCrudPage(container, {
    ...
    fields: [
      ...
      { name: "expectedLifespanMonths", label: "Expected Lifespan (months, optional)", type: "number", placeholder: "e.g. 24 for a tyre or battery" },
    ...
    beforeSave(data) {
      ...
      data.expectedLifespanMonths = data.expectedLifespanMonths === "" ? null : Number(data.expectedLifespanMonths);
      return null;
    },
