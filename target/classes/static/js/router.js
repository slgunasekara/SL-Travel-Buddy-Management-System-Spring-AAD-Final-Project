...
const Router = (() => {
    ...
    function buildShell() {
        ...
        <aside class="sidebar ${collapsed ? "collapsed" : ""}" id="sidebar">
          <div class="sidebar__brand">
            <div class="brand-mark">
              <img src="assets/login-logo.png" alt="SL Travel Buddy Logo" class="logo"
        ...
        <div class="main">
          <header class="topbar">
            ...
            <div class="topbar__right">
              ...
              <button class="fullscreen-trigger" id="fullscreenTrigger" title="Toggle fullscreen" aria-label="Toggle fullscreen">
                <span class="icon--enter-fs">${icon("expand")}</span>
                <span class="icon--exit-fs">${icon("shrink")}</span>
              </button>
      ...
      <a href="${i.hash}" class="sidebar__link" data-hash="${i.hash}" title="${i.label}">
        ...
        const fsBtn = qs("#fullscreenTrigger");
    ...
    function setActive(hash) {
        ...
        qsa(".sidebar__link").forEach(a => a.addEventListener("click", () => {
